...
// repoLabel names the repository the evidence is about. The working directory
// is what warden knows for certain; naming a remote it has not confirmed would
// put an unverified fact in an evidence header.
